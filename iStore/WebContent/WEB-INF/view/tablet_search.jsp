...
<html lang='fr'>
    ...
    <body>
        ...
        <form action="tablet_search" method="POST">
        <ul>
            ...
            <li>Mémoire
                <input type="range" class='range'  name ='memory' value='${memory}' min='25' max='2000' step='1' oninput="updateRangeInput(this)">
                <output></output>    
        	</li> 
            <li>Prix 
                <input type="range" class='range' name ='price' value='${price}' min='156' max='2000' step='1' oninput="updateRangeInput(this)">
                <output></output>
        	</li>
            <li>Réduction 
                <input type="range"  class='range' name ='discount' value='${discount}' min='0' max='1000' step='1' oninput="updateRangeInput(this)">
                <output></output>  
        	</li>
        </ul>
