...
@WebServlet("/export_phones")
public class ExportPhonesXLS extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public ExportPhonesXLS() {
        super();
    }
	...
	try {
		...
		try(HSSFWorkbook wb = new HSSFWorkbook();
			...
			HSSFSheet sheet = wb.createSheet("t_phones");
			...
			int counter=1;
			String str = "SELECT * FROM t_phones";
